...
public enum ResultEnum {
     ...
     UNABLE_TO_EXECVE(9,"unable to execve"),           //无法执行程序
     UNABLE_TO_SET_UID(10,"unable to run as a low power user"),          //无法以低权限用户执行
     UNABLE_TO_LIMIT_MEM(11,"unable to limit memory"),        //无法限制内存
     UNABLE_TO_LIMIT_CPU_TIME(12,"unable to limit cpu time"),   //无法限制cpu时间
     UNABLE_TO_LIMIT_OUTPUT(13,"unable to limit output"),     //无法限制输出大学
     UNABLE_TO_LIMIT_STACK(14,"unable to limit stack"),      //无法限制堆栈
